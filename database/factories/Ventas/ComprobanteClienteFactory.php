...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\ComprobanteCliente>
 */
class ComprobanteClienteFactory extends Factory
{
    protected $model = ComprobanteCliente::class;
