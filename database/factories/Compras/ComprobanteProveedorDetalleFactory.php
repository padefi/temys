...
class ComprobanteProveedorDetalleFactory extends Factory
{
    protected $model = ComprobanteProveedorDetalle::class;

    public function definition(): array
    {
        $usuario = User::inRandomOrder()->first();
        $comprobante = ComprobanteProveedor::inRandomOrder()->first();
