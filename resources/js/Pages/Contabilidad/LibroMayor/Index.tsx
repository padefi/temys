...
import { generarPdf } from "@/utils/generarLibroMayor"
...
export default function Index() {
    ...
    const handleBuscar = () => {
        router.get("/contabilidad/libroMayorListar", {
    ...
    return (
        <AuthenticatedLayout
            header={<h2 className="text-xl font-semibold leading-tight text-gray-800">Libro Mayor</h2>}
        >
            <Head title="Libro Mayor" />

            <div className="p-6 space-y-6">
            <Typography className="text-2xl font-bold text-gray-800">Libro Mayor</Typography>
                {/* =======================
                    FILTROS
                ======================== */}
