            ...
            >
                    ...
                    <div className="relative flex flex-wrap gap-1">
                        ...
                        <CommandPrimitive.Input
                            ...
                            className={cn(
                                "flex-1 bg-transparent outline-none placeholder:text-muted-foreground",
                                {
                                    ...
                                    "px-3 py-2": selected.length === 0,
                                    "border-gray-700-500/50 focus:border-pink-600":
                                        selected.length === 0,
                                    "ml-1": selected.length !== 0,
                                    hidden:
                                        hideInputWhenSelected &&
                                        maxSelected === 1 && selected.length === 1,
                                },
                        ...
                        <button
                            ...
                            className={cn(
                                ...
                                { hidden: maxSelected === 1 && selected.length === 1 },
                ...
                <div className="relative">
                    {open &&
                        !(maxSelected === 1 && selected.length === 1) && (
                            <CommandList
                                className="absolute top-1 z-10 w-full bg-popover text-popover-foreground  outline-none animate-in"
