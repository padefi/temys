...
Route::middleware('module:contabilidad')->group(function () {
    ...
    Route::middleware(['menu:proveedores'])->group(function () {
        ...
        Route::middleware(['submenu:facturasProveedores'])->prefix('contabilidad')
            ->group(function () {
                /////vista principal
                ...
                Route::post('/ordenesPagos', [OrdenPagoController::class, 'store'])
                ->name('ordenesPagos');
        ...
        Route::middleware(['submenu:pagosProveedores'])->prefix('contabilidad')
                ->group(function () {
                    // Vista principal
        ...
        Route::middleware(['submenu:proveedores'])
            ->group(function () {
                // Vista principal
                Route::get('Busquedaproveedores', [ProveedoresController::class, 'index'])
    ...
    Route::middleware(['menu:Contabilidad'])->group(function () {
        ...
        Route::middleware(['submenu:conciliar'])->prefix('contabilidad')
            ->group(function () {
