...
class ComprobanteClienteDetalle extends Model
{
use HasFactory;

    protected $table = 'comprobantes_clientes_detalles';
    protected $fillable = [
    ...
    public function comprobante() {
        return $this->belongsTo(ComprobanteCliente::class, 'comprobante_cliente_id');
    }
    ////IMPUESTOS RELACIONADOS
    public function impuestos() {
        return $this->belongsToMany(
            Impuesto::class,
            'comprobantes_clientes_detalles_impuestos',
            'detalle_id',
            'impuesto_id'
        );
    }
